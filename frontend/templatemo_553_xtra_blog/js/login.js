...
let provider;
const auth = new AuthProvider("f6727e9ace1910a41f3e52c2ca432e1bbc335b31");
...
async function setRequest(value) {
  reqElement.innerText = await value;
  await setResult("-");
}
...
// const serverBlogs = await fetch("http://127.0.0.1:5000/array")
//   .then((response) => response.json())
//   // .then((data) => console.log(data))
//   .catch((error) => console.error(error));
// console.log(serverBlogs);
// export const blogs = serverBlogs;
// function delaying() {
// }
// async function connect() {
//   console.log('requesting connect wallet')
//   await setRequest('connect_wallet')
//   try {
//     const provider = await auth.connect()
//     console.log({ provider })
//   } catch (error) {
